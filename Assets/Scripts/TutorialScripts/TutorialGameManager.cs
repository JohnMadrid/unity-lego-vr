...
public class TutorialGameManager : MonoBehaviour
{
    ...
    public int trialNumber = 0; // change in each trial when fully finished !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    /// <summary>
    /// Initializes the game manager, ensuring only one instance exists.
    /// </summary>
    ...
    //  exposing currentitemindex for screenshotmanager
